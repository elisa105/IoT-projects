...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ADI_ADT7420_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADT7420, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADT7420_TEMP_HYST, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADT7420_TEMP_CRIT, 147);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ADT7420_TRIGGER_NONE, 1);
